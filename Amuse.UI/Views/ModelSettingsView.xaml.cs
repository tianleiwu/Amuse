...
namespace Amuse.UI.Views
{
    ...
    public partial class ModelSettingsView : UserControl, INavigatable, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty UISettingsProperty =
            DependencyProperty.Register("UISettings", typeof(AmuseSettings), typeof(ModelSettingsView), new PropertyMetadata((d, e) =>
            {
                if (d is ModelSettingsView control && e.NewValue is AmuseSettings)
